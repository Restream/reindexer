...
if (LIBUNWIND)
  ...
  SET(CPACK_RPM_PACKAGE_REQUIRES_PRE "${CPACK_RPM_PACKAGE_REQUIRES_PRE},libunwind")
endif()
...
if (LINUX_ISSUE MATCHES "altlinux")
  ...
  SET(CPACK_RPM_PACKAGE_REQUIRES_PRE "${CPACK_RPM_PACKAGE_REQUIRES_PRE},openblas-threads")
endif()
...
if (CPACK_RPM_PACKAGE_REQUIRES_PRE STREQUAL "")
  ...
  foreach (DEP ${CPACK_RPM_PACKAGE_REQUIRES_LIST})
    if ("${DEP}" STREQUAL "gperftools-libs" OR "${DEP}" STREQUAL "libgomp" OR "${DEP}" STREQUAL "openblas-threads")
