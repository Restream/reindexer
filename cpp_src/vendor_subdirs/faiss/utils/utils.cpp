...
void matrix_qr(int m, int n, float* a) {
    ...
    sgeqrf_dlwrp_(&mi, &ni, a, &mi, tau.data(), &work_size, &lwork, &info);
    lwork = size_t(work_size);
    std::vector<float> work(lwork);

    sgeqrf_dlwrp_(&mi, &ni, a, &mi, tau.data(), work.data(), &lwork, &info);

    sorgqr_dlwrp_(&mi, &ni, &ki, a, &mi, tau.data(), work.data(), &lwork, &info);
}
