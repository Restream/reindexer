...
idx_t IOReader::ReadPKEncodedData(uint8_t* /*destBuf*/)
{
    FAISS_THROW_MSG("IOReader does not support PK-encoded data");
}
...
void IOWriter::AppendPKByID(idx_t)
{
    FAISS_THROW_MSG("IOWriter does not support external PKs");
}
