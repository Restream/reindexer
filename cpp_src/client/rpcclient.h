...
public:
	...
	Error Delete(const impl::Query& query, CoroQueryResults& result, const InternalRdxContext& ctx);
	Error Update(const impl::Query& query, CoroQueryResults& result, const InternalRdxContext& ctx);
	Error ExecSQL(std::string_view query, CoroQueryResults& result, const InternalRdxContext& ctx);
	Error Select(const impl::Query& query, CoroQueryResults& result, const InternalRdxContext& ctx) {
...
protected:
	Error selectImpl(const impl::Query& query, CoroQueryResults& result, milliseconds netTimeout, const InternalRdxContext& ctx);
