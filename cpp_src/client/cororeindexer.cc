...
Error CoroReindexer::Update(const impl::Query& q, CoroQueryResults& result) noexcept {
	RETURN_RESULT_NOEXCEPT(impl_->Update(q, result, ctx_));
}
...
Error CoroReindexer::Delete(const impl::Query& q, CoroQueryResults& result) noexcept {
	RETURN_RESULT_NOEXCEPT(impl_->Delete(q, result, ctx_));
}
...
Error CoroReindexer::Select(const impl::Query& q, CoroQueryResults& result) noexcept {
	RETURN_RESULT_NOEXCEPT(impl_->Select(q, result, ctx_));
}
