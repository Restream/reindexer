...
public:
	...
	Error Update(const impl::Query& query, CoroQueryResults& result) noexcept;
	...
	/// @param result - QueryResults with IDs of deleted items
	Error Delete(const impl::Query& query, CoroQueryResults& result) noexcept;
	...
	/// @param result - QueryResults with found items
	Error Select(const impl::Query& query, CoroQueryResults& result) noexcept;
