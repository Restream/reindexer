...
Error Reindexer::Update(const impl::Query& q, QueryResults& result) noexcept { RETURN_RESULT_NOEXCEPT(impl_->Update(q, result, ctx_)); }
Error Reindexer::Update(const Query& query, QueryResults& result) noexcept {
	return impl::Impl{query}.TryExecute([&](const impl::Query& q) noexcept { return Update(q, result); });
}
...
Error Reindexer::Delete(const impl::Query& q, QueryResults& result) noexcept { RETURN_RESULT_NOEXCEPT(impl_->Delete(q, result, ctx_)); }
Error Reindexer::Delete(const Query& query, QueryResults& result) noexcept {
	return impl::Impl{query}.TryExecute([&](const impl::Query& q) noexcept { return Delete(q, result); });
}
...
Error Reindexer::Select(const impl::Query& q, QueryResults& result) noexcept { RETURN_RESULT_NOEXCEPT(impl_->Select(q, result, ctx_)); }
Error Reindexer::Select(const Query& query, QueryResults& result) noexcept {
	return impl::Impl{query}.TryExecute([&](const impl::Query& q) noexcept { return Select(q, result); });
}
