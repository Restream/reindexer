...
static float
InnerProductDistance(const void *pVect1, const void *pVect2, const void *qty_ptr) noexcept {
    return -reindexer::vector_dists::InnerProduct((const float*)pVect1, (const float*)pVect2, *((const size_t*)qty_ptr));
}

static float
InnerProduct(const void *pVect1, const void *pVect2, const void *qty_ptr) noexcept {
    return reindexer::vector_dists::InnerProduct((const float*)pVect1, (const float*)pVect2, *((const size_t*)qty_ptr));
}
...
RX_AVX_TARGET_ATTR
static float
InnerProductDistanceSIMD4ExtAVX(const void *pVect1v, const void *pVect2v, const void *qty_ptr) noexcept {
    return -reindexer::vector_dists::InnerProductSIMD4ExtAVX((const float*)pVect1v, (const float*)pVect2v, *((const size_t*)qty_ptr));
}

RX_AVX_TARGET_ATTR
static float
InnerProductSIMD4ExtAVX(const void *pVect1v, const void *pVect2v, const void *qty_ptr) noexcept {
    return reindexer::vector_dists::InnerProductSIMD4ExtAVX((const float*)pVect1v, (const float*)pVect2v, *((const size_t*)qty_ptr));
}

static float
InnerProductDistanceSIMD4ExtSSE(const void *pVect1v, const void *pVect2v, const void *qty_ptr) noexcept {
    return -reindexer::vector_dists::InnerProductSIMD4ExtSSE((const float*)pVect1v, (const float*)pVect2v, *((const size_t*)qty_ptr));
}

static float
InnerProductSIMD4ExtSSE(const void *pVect1v, const void *pVect2v, const void *qty_ptr) noexcept {
    return reindexer::vector_dists::InnerProductSIMD4ExtSSE((const float*)pVect1v, (const float*)pVect2v, *((const size_t*)qty_ptr));
}

RX_AVX512_TARGET_ATTR
static float
InnerProductDistanceSIMD16ExtAVX512(const void *pVect1v, const void *pVect2v, const void *qty_ptr) noexcept {
    return -reindexer::vector_dists::InnerProductSIMD16ExtAVX512((const float*)pVect1v, (const float*)pVect2v, *((const size_t*)qty_ptr));
}

RX_AVX512_TARGET_ATTR
static float
InnerProductSIMD16ExtAVX512(const void *pVect1v, const void *pVect2v, const void *qty_ptr) noexcept {
    return reindexer::vector_dists::InnerProductSIMD16ExtAVX512((const float*)pVect1v, (const float*)pVect2v, *((const size_t*)qty_ptr));
}

RX_AVX_TARGET_ATTR
static float
InnerProductDistanceSIMD16ExtAVX(const void *pVect1v, const void *pVect2v, const void *qty_ptr) noexcept {
    return -reindexer::vector_dists::InnerProductSIMD16ExtAVX((const float*)pVect1v, (const float*)pVect2v, *((const size_t*)qty_ptr));
}

RX_AVX_TARGET_ATTR
static float
InnerProductSIMD16ExtAVX(const void *pVect1v, const void *pVect2v, const void *qty_ptr) noexcept {
    return reindexer::vector_dists::InnerProductSIMD16ExtAVX((const float*)pVect1v, (const float*)pVect2v, *((const size_t*)qty_ptr));
}

static float
InnerProductDistanceSIMD16ExtSSE(const void *pVect1v, const void *pVect2v, const void *qty_ptr) noexcept {
    return -reindexer::vector_dists::InnerProductSIMD16ExtSSE((const float*)pVect1v, (const float*)pVect2v, *((const size_t*)qty_ptr));
}

static float
InnerProductSIMD16ExtSSE(const void *pVect1v, const void *pVect2v, const void *qty_ptr) noexcept {
    return reindexer::vector_dists::InnerProductSIMD16ExtSSE((const float*)pVect1v, (const float*)pVect2v, *((const size_t*)qty_ptr));
}
FAISS_PRAGMA_IMPRECISE_FUNCTION_END
...
FAISS_PRAGMA_IMPRECISE_FUNCTION_BEGIN
static float
InnerProductDistanceSIMD16ExtResiduals(const void *pVect1v, const void *pVect2v, const void *qty_ptr) noexcept {
    return -(reindexer::vector_dists::InnerProductResiduals16Ext((const float*)pVect1v, (const float*)pVect2v, *((const size_t*)qty_ptr)));
}

static float
InnerProductDistanceSIMD4ExtResiduals(const void *pVect1v, const void *pVect2v, const void *qty_ptr) noexcept {
