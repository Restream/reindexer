...
namespace YAML {
ostream_wrapper::ostream_wrapper() : m_buffer(1, '\0'), m_pStream(nullptr), m_pos(0), m_row(0), m_col(0), m_comment(false) {}

ostream_wrapper::ostream_wrapper(std::ostream& stream) : m_buffer{}, m_pStream(&stream), m_pos(0), m_row(0), m_col(0), m_comment(false) {}
