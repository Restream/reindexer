...
public:
	...
	[[nodiscard]] bool try_lock() noexcept { return !_M_lock.test_and_set(std::memory_order_acq_rel); }
	void unlock() noexcept { _M_lock.clear(std::memory_order_release); }

	[[nodiscard]] const spinlock& operator!() const& { return *this; }
...
public:
	...
	[[nodiscard]] const read_write_spinlock& operator!() const& { return *this; }
	auto operator!() const&& = delete;
...
public:
	...
	[[nodiscard]] const read_write_recursive_spinlock& operator!() const& { return *this; }
	auto operator!() const&& = delete;
