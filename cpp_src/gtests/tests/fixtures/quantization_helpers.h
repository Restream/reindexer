...
void CheckRecallRate(auto& api, std::string_view nsName, const auto& queryPoints, int k, int ef, float expectedRecall = 0.8f,
					 float expectedRecallDiff = kIsRelease ? 0.05 : 0.1, const std::string& hnswIndexName = kHnswIndexName,
					 const std::string& hnswIndexNameQ = kHnswIndexNameQ, const std::string& bfIndexName = kBfIndexName) {
