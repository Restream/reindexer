...
protected:
	...
	void runMultithreadQueries(size_t threads, size_t queriesPerThread, std::string_view nsName, const std::string& fieldName,
	...
	void checkEmptyIndexSelection(std::string_view ns, const std::string& vectorIndex);
