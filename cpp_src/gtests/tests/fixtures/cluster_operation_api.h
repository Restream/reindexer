...
public:
	...
	static constexpr auto kIdField = "id";
	static constexpr auto kStringField = "string";
	static constexpr auto kIntField = "int";
	static constexpr auto kFTField = "ft_str";
	static constexpr auto kVectorField = "vec";
