...
public:
	...
	reindexer::Error Delete(const reindexer::impl::Query& query, reindexer::client::QueryResults& result) {
		return impl_->Delete(query, result, ctx_);
	}
	reindexer::Error Delete(const reindexer::Query& query, reindexer::client::QueryResults& result) { return Delete(*Impl{query}, result); }
	reindexer::Error Update(const reindexer::impl::Query& query, reindexer::client::QueryResults& result) {
		return impl_->Update(query, result, ctx_);
	}
	reindexer::Error Update(const reindexer::Query& query, reindexer::client::QueryResults& result) { return Update(*Impl{query}, result); }
	reindexer::Error Select(const reindexer::impl::Query& query, reindexer::client::QueryResults& result) {
		return impl_->Select(query, result, ctx_);
	}
	reindexer::Error Select(const reindexer::Query& query, reindexer::client::QueryResults& result) { return Select(*Impl{query}, result); }
