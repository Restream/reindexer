...
struct [[nodiscard]] QueryDebugContext {
	...
	const impl::Query* mainQuery = nullptr;
	const impl::Query* externQuery = nullptr;
...
ActiveQueryScope::ActiveQueryScope(const impl::Query& q, QueryType realQueryType, const std::atomic<OptimizationState>& nsOptimizationState,
								   StringsHolder* strHolder) noexcept
...
ActiveQueryScope::ActiveQueryScope(const impl::Query& q, QueryType realQueryType) noexcept : type_(Type::ExternalQueryTracker) {
