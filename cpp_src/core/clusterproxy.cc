...
Error ClusterProxy::Update(const impl::Query& q, LocalQueryResults& qr, const RdxContext& ctx) {
	auto action = [this](const RdxContext& ctx, LeaderRefT clientToLeader, const impl::Query& q, LocalQueryResults& qr) {
...
Error ClusterProxy::Delete(const impl::Query& q, LocalQueryResults& qr, const RdxContext& ctx) {
	auto action = [this](const RdxContext& ctx, LeaderRefT clientToLeader, const impl::Query& q, LocalQueryResults& qr) {
...
Error ClusterProxy::Select(const impl::Query& q, LocalQueryResults& qr, const RdxContext& ctx) {
	using namespace std::placeholders;
...
bool ClusterProxy::shouldProxyQuery(const impl::Query& q) {
...
Error ClusterProxy::resultFollowerAction(const RdxContext& ctx, LeaderRefT clientToLeader, const impl::Query& query,
