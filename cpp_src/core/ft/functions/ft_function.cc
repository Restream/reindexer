...
FtFunction::Ptr FtFunctionsHolder::AddNamespace(const impl::Query& q, const NamespaceImpl& nm, uint32_t nsid, bool force) {
...
FtFunction::FtFunction(const impl::Query& q, NsFtFuncInterface&& nm) : nm_(std::move(nm)), currCjsonFieldIdx_(nm_.getIndexesCount()) {
