...
public:
	...
	void AddIndex(BaseHolder::Ptr& holder, std::string_view src_data, const reindexer::IdType id, unsigned field, unsigned arrayIdx,
...
private:
	...
	void AddIdToInfo(Info* info, const reindexer::IdType id, std::pair<PosType, ProcType> pos, uint32_t total_size);
