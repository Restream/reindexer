...
static void mktyposInternal(typos_context *ctx, const wstring &word, int level, int maxTyposLen, typos_context::CallBack callback) {
...
void mktypos(typos_context *ctx, const wstring &word, int level, int maxTyposLen, typos_context::CallBack callback) {
