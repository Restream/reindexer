...
private:
	...
	Item newItem();
	void doUpdate(LocalQueryResults& result, UpdatesContainer& pendedRepl, const impl::Query& query, const NsContext& ctx,
				  const functions::PrecomputedValues&);
	void doUpdateTr(LocalQueryResults& result, UpdatesContainer& pendedRepl, const impl::Query& query, const NsContext& ctx,
					const functions::PrecomputedValues&);
	void doDelete(LocalQueryResults& result, UpdatesContainer& pendedRepl, const impl::Query& query, const NsContext& ctx,
				  const functions::PrecomputedValues&);
	void doDeleteTr(LocalQueryResults& result, UpdatesContainer& pendedRepl, const impl::Query& query, const NsContext& ctx,
					const functions::PrecomputedValues&);
	...
	void getFromJoinCache(const impl::Query&, const impl::JoinedQuery&, joins::CacheRes& out) const;
	void getFromJoinCache(const impl::Query&, joins::CacheRes& out) const;
