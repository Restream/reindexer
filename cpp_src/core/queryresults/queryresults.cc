...
void QueryResults::SetQuery(const impl::Query* q) {
	if (q) {
		QueryData data;
...
public:
	Comparator(QueryResults& qr, const impl::Query& q, const NamespaceImpl& ns) : qr_{qr} {
...
void QueryResults::SetOrdering(const impl::Query& q, const NamespaceImpl& ns, const RdxContext& ctx) {
