...
class [[nodiscard]] JoinItemsProcessorMock {
public:
	JoinItemsProcessorMock(JoinType jt, reindexer::impl::JoinedQuery q, unsigned limit, unsigned offset)
		: query_{std::move(q)}, qr_{}, joinType_{jt}, limit_{limit}, offset_{offset} {}
	const reindexer::impl::JoinedQuery& JoinQuery() const noexcept { return query_; }
...
private:
	reindexer::impl::JoinedQuery query_;
