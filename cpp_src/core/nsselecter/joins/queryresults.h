...
public:
	...
	/// Gets/sets amount of items processors
	/// @param joinItemsProcessorsCount - joinItemsProcessors.size()
	void SetItemsProcessorsCount(uint32_t joinItemsProcessorsCount) noexcept { joinItemsProcessorsCount_ = joinItemsProcessorsCount; }
	uint32_t GetJoinItemsProcessorsCount() const noexcept { return joinItemsProcessorsCount_; }
...
private:
	...
	uint32_t joinItemsProcessorsCount_ = 0;
};
...
public:
	...
	int getJoinedFieldsCount() const noexcept { return joinRes_->GetJoinItemsProcessorsCount(); }
