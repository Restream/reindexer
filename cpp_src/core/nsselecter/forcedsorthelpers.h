...
public:
	ForcedPartitionerComposite(const ValueGetter& valueGetter, unordered_payload_map_fast<std::ptrdiff_t>& sortMap) noexcept
...
private:
	const ValueGetter& valueGetter_;
	const unordered_payload_map_fast<std::ptrdiff_t>& sortMap_;
};
...
public:
	ForcedComparatorComposite(const ValueGetter& valueGetter, const ItemComparator& compare,
							  const unordered_payload_map_fast<std::ptrdiff_t>& sortMap) noexcept
