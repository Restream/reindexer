...
#pragma message("Checking macro defs")
#ifdef __clang_major__
#pragma message("Clang major version: " __clang_major__)
static_assert(__clang_major__ == 14, "Checking clang major version");
#endif

#ifdef __apple_build_version__
#pragma message("Apple build version: " __apple_build_version__)
#endif
#pragma message("End checking macro defs")
