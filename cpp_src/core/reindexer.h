...
public:
	...
	Error Update(const impl::Query& query, QueryResults& result) noexcept;
	...
	Error Delete(const impl::Query& query, QueryResults& result) noexcept;
	...
	Error Select(const impl::Query& query, QueryResults& result, unsigned proxyFetchLimit = 10000) noexcept;
